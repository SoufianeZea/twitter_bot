...
def send_tweet(client)
 ...
 client.update ("#{arry[i]} Hi I'm using the Twitter gem thanks to @the_hacking_pro
 to congratulate you on your service to the world.
 #Hello World
 #PEACE ")
...
client.search("#bonjour_monde -rt").take(25).map do |tweet|
...
def follow(client)
  ...
  client.search("#bonjour_monde -rt").take(20).map do |tweet|
